...
CAnimation3D* CAnimator3D::CreateAnimByFrame(const wstring& _strName, int    _clipNum
...
CAnimation3D* CAnimator3D::CreateAnimByTime(const wstring& _strName, int      _clipNum
